...
function guardaryeditar(e){
    ...
    $.ajax({
        url: "../../controllers/instructor.php?op=guardaryeditar",
        type: "POST",
        data: formData,
        contentType: false,
        processData: false,
...
$(document).ready(function(){
    ...
    $('#instructor_data').DataTable({
        ...
        "ajax":{
            url:"../../controllers/instructor.php?op=listar",
            type:"post"
        },
        "bDestroy": true,
        "responsive": true,
...
function editar(inst_id){
    $.post("../../controllers/instructor.php?op=mostrar",{inst_id : inst_id}, function (data) {
...
function eliminar(inst_id){
    swal.fire({
        ...
        if (result.value) {
            $.post("../../controllers/instructor.php?op=eliminar",{inst_id : inst_id}, function (data) {
                $('#instructor_data').DataTable().ajax.reload();
