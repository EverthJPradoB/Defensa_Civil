    ...
    $('#cur_id').change(function () {
        ...
        $("#cur_id option:selected").each(function () {
            ...
            $('#detalle_data').DataTable({
                ...
                "ajax": {
                    url: "../../controllers/usuario.php?op=listar_cursos_usuario",
                    type: "post",
                    data: { cur_id: cur_id },
                },
                "bDestroy": true,
...
function listar_usuario(cur_id) {
    $('#usuario_data').DataTable({
        ...
        "ajax": {
            url: "../../controllers/usuario.php?op=listar_detalle_usuario",
            type: "post",
            data: { cur_id: cur_id },
...
function eliminar(curd_id) {
    swal.fire({
        ...
        if (result.value) {
            $.post("../../controllers/curso.php?op=eliminar_curso_usuario", { curd_id: curd_id }, function (data) {
...
function combo_curso() {
    $.post("../../controllers/curso.php?op=combo", function (data) {
        $('#cur_id').html(data);
    });
}
...
function registrardetalle() {
    ...
    if (usu_id == 0) {
        ...
        console.log(formData.cur_id);

        $.ajax({
            url: "../../controllers/curso.php?op=insert_curso_usuario",
            type: "POST",
            data: formData,
            contentType: false,
            processData: false,
        ...
        // se pone esto para ue cuando se "elimina un usuario de un cursos este 
       // se reloge rapido en el data table de la elecion de los usuario para los cursos(modalmantenimiento)
