$(document).ready(function () {
    ...
    $("#solicitud_6_form").on("submit", function (e) {
...
function visualizar(tipo_anexo) {
    ...
    $.post("../../controllers/solicitud.php?op=mostrar_anexo_06_07_09", { tipo_anexo: tipo_anexo }, function (data) {
        ...
        if (data.html) {
            ...
            $("#anexo6_tipoItse").html(data.html);
...
function visualizar_detalle_parte1(tipo_anexo) {
    ...
    $.post("../../controllers/solicitud.php?op=mostrar_detalle_anexo_06_parte1", { tipo_anexo: tipo_anexo }, function (data) {

        // Manejar la respuesta del servidor
        if (data.html) {

            // Pegar el HTML directamente en el div con ID form_anexo_04
            $("#container_detalle_anexo06_parte1").html(data.html);
