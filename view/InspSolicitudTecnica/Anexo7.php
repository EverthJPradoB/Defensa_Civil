...
?>
    ...
    <body>
            ...
            <div class="br-pagebody mg-t-5 pd-x-30 table-responsive">
                <div class="card pd-0 bd-0 shadow-base">
                    ...
                    <ul class="nav nav-pills nav-fill mb-3">
                        <li class="nav-item">
                            <a class="nav-link active" id="step1-tab" data-toggle="pill" href="#step1" onclick="changeStep(1)">ANEXO 07</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="step2-tab" data-toggle="pill" href="#step2" onclick="changeStep(2)">ANEXO 7a</a>
                        </li>
                    ...
                    if (
                        ...
                        <form id="solicitud_7_form" method="post" data-parsley-validate>
                            ...
                            <div id="form-wizard">
                                <div class="tab-content">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="card">
                                                <div class="card-header">
                                                    <h6 class="mb-0 text-center" style="color: black;">ANEXO 07
                                                        INFORME DE ITSE PREVIA AL OTORGAMIENTO DE LA LICENCIA DE FUNCIONAMIENTO O LA ITSE PREVIA
                                                        AL INICIO DE ACTIVIDADES</h6>
                                                </div>
                                                <div class="card-body ">

                                                    <?php

                                                    require_once("../html/solicitud/Anexos/Anexo07/index.php");
                                    ...
                                    <div class="tab-pane fade" id="step2" require>
                                        <div class="form-group">

                                            <div class="card">
                                                <div class="card-header">
                                                    <h6 class="mb-0 text-center" style="color: black;">ANEXO 7a
                                                        OBSERVACIONES SUBSANABLES A SER LEVANTADAS POR EL ADMINISTRADO</h6>
                                                </div>
                                                <div class="card-body ">
                                                    ...
                                                    <div class="tab-content" id="myTabsContent">
                                                        <div class="tab-pane fade show active" id="tab1" role="tabpanel" aria-labelledby="tab1-tab">
                                                            ...
                                                            <?php
                                                            require_once("../html/solicitud/Detalles/detalleAnexo7/index.php");
                                                        ...
                                                        <div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
                                                            ...
                                                            <?php
                                                            require_once("../html/solicitud/Detalles/detalleAnexo7/parte2.php");
        ...
        <script type="text/javascript" src="informe_anexo7.js"></script>
