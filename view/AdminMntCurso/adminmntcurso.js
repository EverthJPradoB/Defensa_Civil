...
function guardaryeditar(e) {
    ...
    $.ajax({
        url: "../../controllers/curso.php?op=guardaryeditar",
        type: "POST",
        data: formData,
        contentType: false,
        processData: false,
...
$(document).ready(function () {
    ...
    $('#cursos_data').DataTable({
        ...
        "ajax": {
            url: "../../controllers/curso.php?op=listar",
            type: "post"
        },
        "bDestroy": true,
        "responsive": true,
...
function eliminar(cur_id) {
    swal.fire({
        ...
        if (result.value) {
            $.post("../../controllers/curso.php?op=eliminar", { cur_id: cur_id }, function (data) {
                $('#cursos_data').DataTable().ajax.reload();
...
function combo_instructor() {
    $.post("../../controllers/instructor.php?op=combo", function (data) {
        $('#inst_id').html(data);
    });
}
...
function guardaryeditarimg(e) {
    ...
    $.ajax({
        url: "../../controllers/curso.php?op=update_imagen_curso",
        type: "POST",
        data: formData,
        contentType: false,
        processData: false,
