...
?>
    ...
    <body>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body ">
                                ...
                                <ul class="nav nav-pills nav-fill mb-3">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="step1-tab" data-toggle="pill" href="#step1" onclick="changeStep(1)">I.- II.-II. - INFORMACION</a>
                                    </li>
                                    <li class="nav-item">
                                    ...
                                    <div id="form-wizard">
                                        <div class="tab-content">
                                            <div class="tab-pane fade show active" id="step1">
                                                <div class="form-group" id="infoGeneral">
                                        ...
                                        <div class="form-group" style="display: flex;justify-content: space-between;">
                                            <div class="form-group">
                                                <button type="button" class="btn btn-warning" id="editaInputsEnable">Habilitar Edición</button>
                                                <button type="button" class="btn btn-secondary"  id="editaInputsDisable">Desabilitar Edición</button>
                                            </div>
        ...
        <script type="text/javascript" src="UsuMntSolicitud.js"></script>


        <script type="text/javascript" src="UsuMntSolicitudDetalle_1.js"></script>
