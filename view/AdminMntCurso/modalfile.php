        ...
        <div class="modal-content bd-0">
            ...
            <form method="post" id="detalle_form">
                ...
                <div class="modal-footer">
                    ...
                    <button name="action"type="submit" class="btn btn-outline-primary tx-11 tx-uppercase pd-y-12 pd-x-25 tx-mont tx-medium"><i class="fa fa-check"></i> Guardar</button>
