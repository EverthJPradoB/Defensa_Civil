...
?>
    ...
    <body>
                            ...
                            <div class="pd-x-15 pd-b-15">
                                ...
                                <div class="table-wrapper">
                                    <table id="solicitud_data" class="table display responsive nowrap">
                                        <thead>
                                            <tr>
                                                <th class="wd-5p">Nº de expediente</th>
                                                <th class="wd-5p">DNI- CE</th>
                                                <th class="wd-5p">Nombre del representate</th>
                                                <th class="wd-5p">RUC N</th>
                                                <th class="wd-5p">Fecha de Registro</th>
                                                <th class="wd-5p"></th>
        ...
        <script type="text/javascript" src="InspSolicitudHome.js"></script>
