...
?>
    ...
    <body>
        ...
        <div class="br-mainpanel pb-5">
            ...
            <div class="br-pagebody mg-t-5 pd-x-30 table-responsive">
                ...
                <div class="card pd-0 bd-0 shadow-base">
                    ...
                    if (isset($_SESSION["opcionAnexo_1_idesx"]) &&  isset($_SESSION["opcionAnexo_2_idesx"])) { ?>

                        <!--   si no existe el anexo 3, se podra registrar recien-->
                        <?php if (!isset($_SESSION["opcionAnexo_3_idesx"])) { ?>
                            <form method="post" id="detalle_form">
                                ...
                                <!-- <ul class="nav nav-tabs" id="myTabs">
                                    ...
                                    <li class="nav-item">
                                        <button type="button" class="nav-link " id="tab2Btn" onclick="showTab('tab2')">Anexo 3</button>
                                    </li>
                                </ul> -->
                                ...
                                <div id="tab1" class="tab-content mt-0 active">
                                    ...
                                    <?php
                                    require_once("../html/solicitud/Detalles/detalleAnexo3/index.php");
                                    ?>
                        ...
                        <?php  } else {   ?>
                            ...
                            <div class="alert alert-success" role="alert">
                                ...
                                <p>Ya a sido Ingreado el Anexo 3 Correctamente</p>
                            </div>
        ...
        <script type="text/javascript" src="UsuSolicitudAnexo3.js"></script>
